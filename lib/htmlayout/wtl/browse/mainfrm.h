...
public:
  ...
  BEGIN_MSG_MAP(CMainFrame)
    ...
    COMMAND_ID_HANDLER(ID_TESTS_SETCTLVALUE, OnTestSetCtlValue)
...
//  LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
  ...
  LRESULT OnTestSetCtlValue(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
  {
    htmlayout::dom::element root = htmlayout::dom::element::root_element(m_view);
    htmlayout::dom::element el = root.find_first("#test-input");

    ATLASSERT(el.is_valid());

    json::value val = json::value::from_string(L"2012-02-25");
...
*/
  ...
  LRESULT OnTestCSS(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
  {
    ...
    */
    ...
    //const wchar_t* b = test.get_style_attribute("height");
...
//#pragma setlocale("russian")
  ...
  LRESULT OnTestSelection(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
  {
    ...
    htmlayout::dom::editbox ed = root.find_first("textarea, widget[type='htmlarea'],plaintext, input[type='text'], richtext");
    if(!ed.is_valid())
    {
